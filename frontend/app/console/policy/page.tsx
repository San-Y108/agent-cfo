...
/* ─── 5 rule categories (Neural Guardrails node IDs) ─── */
const RULES = [
      ...
      <div className="px-6 py-8 lg:px-10 lg:py-10">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            <div className="w-8 h-8 rounded-lg bg-[#FB7185]/10 border border-[#FB7185]/20 flex items-center justify-center">
              <Shield className="w-4 h-4 text-[#FB7185]" />
            </div>
            <span className="text-[11px] font-medium uppercase tracking-[0.18em] text-[#FB7185] font-mono">
              {_("神经网络护栏", "Neural Guardrails")}
            </span>
          </div>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full font-mono text-[11px] font-bold bg-white/[0.05] border border-white/[0.08] text-fg">
...
/* =============================================================================
 * RULES SATELLITE — Left-side rule node list that syncs with the graph.
 * ===========================================================================*/
...
function RulesSatellite({
  ...
  return (
    <FrostedPanel glowColor="coral" sheen className="h-full flex flex-col">
...
/* =============================================================================
 * THRESHOLD SATELLITE — Right-side limit adjuster + integrity cards.
 * ===========================================================================*/
...
/* =============================================================================
 * WHITELIST STRIP — Bottom horizontal satellite with add/delete.
 * ===========================================================================*/
