...
export function HSMMonitor() {
  ...
  return (
    <div className="md:col-span-2 p-6 border border-white/10 rounded-2xl bg-gradient-to-b from-neutral-900 to-black flex flex-col justify-between relative overflow-hidden group">
      ...
      <div className="space-y-4 relative z-10">
        ...
        <div className="flex justify-between items-center border-b border-white/5 pb-4">
          ...
          <span className="text-[9px] font-mono px-2 py-0.5 rounded bg-white/5 text-white/80 border border-white/15">
            TLS V1.3 SECURE
          </span>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <div className="p-3 bg-white/[0.02] border border-white/5 rounded-lg">
            <span className="text-[9px] font-mono text-white/40 block mb-0.5">
              {t("hsm.latency")}
            </span>
        ...
        {/* Load bar */}
        <div className="p-3 bg-white/[0.02] border border-white/5 rounded-lg space-y-1.5 mt-2">
      ...
      {/* Footer CTA */}
      <div className="mt-8 pt-4 border-t border-white/5 flex items-center justify-between text-xs relative z-10">
