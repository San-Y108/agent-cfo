 ...
 *
 * A dark, pixelated particle field for the Hero section.
 * Inspired by TRAE's point-cloud background, but adapted for
 * AgentCFO's financial command center aesthetic.
 *
 * Features:
 * - Multi-layer square particles (depth field)
 * - Mouse-driven ripple displacement
 * - Vignette mask to preserve content readability
...
export function AgentCFOBackgroundTexture() {
