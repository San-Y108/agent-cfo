...
/**
 * Shooting Stars — Aceternity-style background effect.
 * Adapted for AgentCFO dark theme.
 * Stars shoot across the screen with configurable colors.
 */
...
/**
 * Background with Shooting Stars — ready-to-use wrapper.
 */
