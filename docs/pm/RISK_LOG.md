...
| 当前状态 | ⚠️ 已过截止时间（18:00），团队第 5 人的 GitHub 用户名仍未提供 |
| 缓解措施 | 必须今天确认物料同学是谁，拉进 repo；如果今晚 22:00 前仍无回复，启动兜底：总控自己出 PPT 大纲 + 视频脚本框架 |
| 兜底方案 | 总控 + 后端/前端协助完成最小可用 PPT 和视频脚本 |
| 截止 | 6月8日 22:00（硬截止） |
