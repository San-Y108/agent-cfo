...
队友或 AI 先把**未归类的草稿、导出物、截图**放在这里；整理后应迁入正式目录并删除本区文件。
...
| 团队微信头像 | `assets/images/readme/team/` | 源文件命名 `职位-昵称.jpg`；归档为 `team/{昵称}-role.jpg` |

## 当前状态

README 相关素材已部分迁入 `assets/images/readme/`；合并规划见 [`docs/plans/README-merge-plan.md`](../docs/plans/README-merge-plan.md)。整理后请从本目录删除已归类文件。
